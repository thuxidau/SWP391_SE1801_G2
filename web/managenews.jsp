...
<html lang="en">
                                                    ...
                                                    <td class="d-flex justify-content-start align-items-center">
                                                        ...
                                                        <a class="btn btn-info btn-sm text-light mr-2" 
                                                           ...
                                                           data-target="#updateNewsModal">
                                                            Chỉnh sửa</a>
                                                        <input type="hidden" id="contentFirst" value="<%=n.getContentFirst()%>">
                                                        <input type="hidden" id="contentBody" value="<%=n.getContentBody()%>">
                                                        <input type="hidden" id="contentEnd" value="<%=n.getContentEnd()%>">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="categoriesSelect" onchange="checkValidVoucher()">
    ...
    <div class="modal fade" id="updateNewsModal" tabindex="-1" role="dialog" aria-labelledby="updateBrandModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="name">Lựa chọn thể loại:</label>
                        <select class="form-control" id="categoriesSelectUpdate" onchange="checkValidVoucher()">
                            <option value="0" selected>Lựa chọn thể loại</option>
                            <% for (CategoriesNews c : dataCate) { %>
                            <option id="voucherValid" value="<%= c.getID() %>">
                                <%= c.getTitle() %>
