                                                                    ...
                                                                    <tr>
                                                                        <td colspan="3" class="text-center">
                                                                            <form class="deposit-form">
                                                                                <input type="text" id="amount" name="amount" placeholder="VNĐ" required>
                                                                                <br>
                                                                                <button class="btn btn-info" type="button" onclick="deposit(document.getElementById('amount').value)">Thực hiện nạp tiền</button>
                                                                            </form>
                                                                            <div id ="deniedPayment"></div>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
	...
	<script src="https://cdn.jsdelivr.net/npm/sweetalert2@10/dist/sweetalert2.all.min.js"></script>
        ...
        <script>
                                                                                    function deposit(amount) { 
                                                                                        $.ajax({
                                                                                            url: '/TheCardWebsite/depositajaxsvl',
                                                                                            type: 'POST',
                                                                                            data: {
                                                                                                amount: amount
                                                                                            },
                                                                                            success: function (data) {
                                                                                                if (data.includes("Bạn đang có một giao dịch chưa hoàn thành")) {
                                                                                                    $('#deniedPayment').html(data);
                                                                                                } else {
